...
const Info = () => {
  ...
  const reviewsData = [
    { platform: 'FACEBOOK', reviews: loading ? 'Loading...' : reviews.length, replied: loading ? 'Loading...' : 0, pending: loading ? 'Loading...' : reviews.length, bgColor: '#FDDAC1', textColor: '#F98F45', className: 'orange' },
    { platform: 'TRIPADVISOR', reviews: loading ? 'Loading...' : data.length, replied: loading ? 'Loading...' : 0, pending: loading ? 'Loading...' : data.length, bgColor: '#B0DAD9', textColor: '#0F7876', className: 'green' },
